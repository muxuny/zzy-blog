...
test('reading space fills the continuation panel with a playful magnetic field', () => {
  ...
  assert.match(source, /class="magnetic-particle/)
  assert.match(source, /class="magnetic-ripple"/)
  assert.match(source, /@pointermove="updateReadingField"/)
  assert.match(source, /@pointerleave="resetReadingField"/)
  ...
  assert.doesNotMatch(source, /overview\.historyTotal[\s\S]{0,700}magnetic-field/)
  assert.doesNotMatch(source, /overview\.favoriteTotal[\s\S]{0,700}magnetic-field/)
})
